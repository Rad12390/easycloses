...
function RoleClass() {
    ...
    main.initEvent = function () {
        $("#btn_save", main.container).click(function () {
            setTemplateData(_getTemplateData(), main.creator_info["id"]);
            var $modal = $($('#modal-center').html());
            var $content = '<p>The template has been successfully saved.</p>';
        ...
        $("#btn_add_sign_role", main.container).click(function () {
            ...
            // sign role name
            var $sign_role_name = $('<input name="role_name" type="text" class="form-control mb-4" placeholder="Sign Role Name" value="' + main.createSignRoleId('role-') + '">');
